...
/// <summary>
/// Basis-Implementierung f�r registrierbare Entities.
/// - Stabile GUID �ber GuidProvider
/// - TypeId f�r Addressables/Factory
...
public class RegistrableEntity : MonoBehaviour, IRegistrableEntity
{
    ...
    [Tooltip("Addressables-/Factory-Key zum Respawn dieser Entit�t.")]
    ...
    [Tooltip("Beim Zerst�ren automatisch aus WorldRegistry entfernen.")]
    ...
    {
        // Nichts � das Objekt k�nnte nur tempor�r disabled sein
    }
...
/// So k�nnen spezialisierte Entit�ten ihren Zustand selbst in/aus JSON serialisieren.
/// </summary>
